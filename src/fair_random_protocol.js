...
export class FairRandomProtocol {
    // needs change 
    static async decideFirstMove(cli) {
        console.log("Let's determine who makes the first move.");
        const computerNumber = RandomGenerator.secureRandomInt(0, 1);
        ...
        const userNumber = await cli.askForChoice('Try to guess my selection', {"0": 0, "1": 1});
